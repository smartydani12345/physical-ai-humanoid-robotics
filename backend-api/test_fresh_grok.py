#!/usr/bin/env python3
"""
Fresh test script to verify Grok integration in the RAG system
"""
...
async def test_grok_integration():
    ...
    try:
        ...
        print(f"+ Grok API key available: {'Yes' if hasattr(settings, 'grok_api_key') and settings.grok_api_key else 'No'}")
        ...
        if health_status:
            ...
            print()
            print("Testing full RAG flow with Grok...")
